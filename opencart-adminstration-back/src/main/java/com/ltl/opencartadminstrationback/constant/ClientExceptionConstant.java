package com.ltl.opencartadminstrationback.constant;
...
public class ClientExceptionConstant {
    ...
    public static final String ADMINISTRATOR_PASSWORD_INVALID_ERRCODE = "0102";
    public static final String ADMINISTRATOR_PASSWORD_INVALID_ERRMSG = "administrator password invalid";
    public static final String ADMINISTRATOR_PWDRESET_EMAIL_NONE_ERRCODE = "0103";
    public static final String ADMINISTRATOR_PWDRESET_EMAIL_NONE_ERRMSG = "administrator password reset email none";
    public static final String ADMINISTRATOR_PWDRESET_INNER_RESETCODE_NONE_ERRCODE = "0104";
    public static final String ADMINISTRATOR_PWDRESET_INNER_RESETCODE_NONE_ERRMSG = "administrator password inner reset code none";
    public static final String ADMINISTRATOR_PWDRESET_OUTER_RESETCODE_NONE_ERRCODE = "0105";
    public static final String ADMINISTRATOR_PWDRESET_OUTER_RESETCODE_NONE_ERRMSG = "administrator password outer reset code none";
